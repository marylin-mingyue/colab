...
export const APP_NAME = (import.meta.env.VITE_APP_NAME as string | undefined) ?? 'FinVerse'
export const APP_TAGLINE =
  (import.meta.env.VITE_APP_TAGLINE as string | undefined) ?? (IS_DEMO ? 'GenZ RWA + ESG' : 'Learning + simulation, built for real users')

export const STORAGE_KEY =
  (import.meta.env.VITE_STORAGE_KEY as string | undefined) ?? 'finverse:v1'
