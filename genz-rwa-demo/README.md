...
- **Module 3 — Real Invest**: spend a **programmable e-HKD voucher concept** into low-risk assets (mock)
...
3. Go to **Simulator**, run 30 days, keep PnL positive
4. **Claim 50 e-HKD** voucher (mock reward)
5. Go to **Real Invest** and spend voucher (mock)
